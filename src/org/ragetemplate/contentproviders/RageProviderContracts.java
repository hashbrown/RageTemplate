...
public final class RageProviderContracts {
	...
	public static final class RageComics implements BaseColumns {
		...
		private static final String URI_PATH_DEVICES = "/rage";
		// Note the slash on the end of this one, as opposed to the PATH_NODES, which has no slash.
		private static final String URI_PATH_WITH_DEVICE_ID = "/rage/";
		public static final int DEVICE_ID_PATH_POSITION = 1;

		public static final Uri CONTENT_URI = Uri.parse(SCHEME + AUTHORITY + URI_PATH_DEVICES);
		public static final Uri CONTENT_ID_URI_BASE = Uri.parse(SCHEME + AUTHORITY + URI_PATH_WITH_DEVICE_ID);
		public static final Uri CONTENT_ID_URI_PATTERN = Uri.parse(SCHEME + AUTHORITY + URI_PATH_WITH_DEVICE_ID + "/#");
